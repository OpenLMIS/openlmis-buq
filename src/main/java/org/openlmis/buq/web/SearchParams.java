...
import static org.openlmis.buq.i18n.MessageKeys.ERROR_INVALID_FORMAT_BOOLEAN;
import static org.openlmis.buq.i18n.MessageKeys.ERROR_INVALID_FORMAT_DATE;
import static org.openlmis.buq.i18n.MessageKeys.ERROR_INVALID_FORMAT_UUID;
...
import org.openlmis.buq.util.UuidUtil;
...
public final class SearchParams {
  ...
  public Boolean getBoolean(String key) {
    ...
    if (booleanValue == null) {
      throw new ValidationMessageException(new Message(ERROR_INVALID_FORMAT_BOOLEAN, value, key));
    }
    return booleanValue;
  }
