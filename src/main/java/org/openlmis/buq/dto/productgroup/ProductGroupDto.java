...
public final class ProductGroupDto extends BaseDto implements ProductGroup.Importer,
        ProductGroup.Exporter {
   ...
   */
  public static ProductGroupDto newInstance(ProductGroup productGroup) {
