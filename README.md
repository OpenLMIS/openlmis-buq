# OpenLMIS Bottom-Up Quantification Service
This repository holds the files for the OpenLMIS Bottom-Up Quantification Independent Service.
...
1. Fork/clone this repository from GitHub.
 ...
 ```shell
 git clone https://github.com/OpenLMIS/openlmis-buq.git
 ```
2. Add an environment file called `.env` to the root folder of the project, with the required
 ...
 ```
3. Develop w/ Docker by running `docker-compose run --service-ports buq`.
